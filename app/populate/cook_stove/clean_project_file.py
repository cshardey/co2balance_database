    ...
    if data is not None:
        ...
        for sheet in data:
            project_data = data.get(sheet)[
                ["start", "end", "Enumerator", "House number",
                 "Confirm all fuels used by the household will be measured and included in the survey.",
                 "Do you consent to completing the survey?", "Name of the Head of Household?", "Name of survey respondent.",
                 "Phone number of survey respondent?", "Region?", "District?", "_GPS?_latitude", "_GPS?_longitude",
                 "_GPS?_altitude", "How many types of stove does the household use?",
                 ...
                 "Take a photo of the traditional 3 stone fire_URL", "Take a photo of the ethanol/alcohol stove",
                 "Select all fuels used for cooking by the household:", "Weigh the contents of the wood USE pile.",
                 "Any additional comments?", "Village?", "House number",
            ...
            project_data["head_of_household"] = project_data["head_of_household"].str.title()
